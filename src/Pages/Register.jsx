    ...
    <>
      ...
      <div className="mt-35 mb-20">
        <form
          ...
          className="max-w-md mx-auto p-6 rounded shadow-md bg-white " //bg-gradient-to-r from-gray-400 to-violet-700
        >
          <div className="font-bold text-3xl mb-10 flex justify-center text-orange-500 p- uppercase ">
            Sign Up
          </div>
          ...
          <button
            className="bg-gradient-to-r from-(--color-fireworks1)
            to-(--color-fireworks2) hover:bg-gradient-to-l hover:from-bg-violet-700 hover:to-bg-blue-700
