      ...
      <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
        <div className="grid gap-10 row-gap-8 lg:grid-cols-3">
          <div>
            ...
            <p data-aos="zoom-out" data-aos-duration="2000" className="mb-2 font-bold md:text-lg">Members</p>
          ...
          <div>
            ...
            <p data-aos="zoom-out" data-aos-duration="2000" className="mb-2 font-bold md:text-lg">Fund Raised</p>
